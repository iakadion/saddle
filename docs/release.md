...
|---|---|---|
| package version | repository | `package.json` is `1.8.0` |
| quality gate | GitHub Actions | `npm run pack:check` passes |
| tag | repository owner | tag `v1.8.0` points to the validated release commit |
| GitHub release | repository owner | release `v1.8.0` is created from the validated tag |
