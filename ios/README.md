...
The public artifact contract is version-derived and uses the dotted lowercase pattern `saddle.ipa.1.8.11.ipa`. Generated Xcode build directories and temporary archives remain excluded from version control.
