...
Release filenames identify the user-facing desktop browser with the dotted lowercase pattern `saddle.browser.1.8.13.<format>`. Internal module filenames remain API-compatible unless a deliberate public compatibility migration is documented.
