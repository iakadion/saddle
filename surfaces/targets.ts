...
export const targetprofiles = Object.freeze({
  ...
  desktopapp: { runtime: "caller", entry: "dist/index.js", capabilities: ["memory", "file", "visible"], formats: ["appimage", "deb", "rpm", "snap", "flatpak", "dmg", "pkg", "exe", "msi", "msix"] },
  mobileapp: { runtime: "browser", entry: "dist/index.js", capabilities: ["memory", "network", "visible"], formats: ["apk", "aab", "ipa"] },
  android: { runtime: "android", entry: "dist/index.js", capabilities: ["memory", "network", "visible"], formats: ["apk", "aab"] },
  ios: { runtime: "ios", entry: "dist/index.js", capabilities: ["memory", "network", "visible"], formats: ["ipa"] },
  ...
  browser: { runtime: "browser", entry: "dist/index.js", capabilities: ["memory", "network", "visible"], formats: ["html", "pwa", "wasm"] },
